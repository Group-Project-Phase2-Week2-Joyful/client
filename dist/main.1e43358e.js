...
exports.default = _default;
        var $f09969 = exports.default || module.exports;
      
      if (typeof $f09969 === 'function') {
        $f09969 = $f09969.options;
      }
    
        /* template */
        Object.assign($f09969, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f09969', $f09969);
          } else {
            api.reload('$f09969', $f09969);
          }
        }
